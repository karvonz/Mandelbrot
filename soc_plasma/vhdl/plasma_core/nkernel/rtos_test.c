...
{
   UartPrintfCritical("Starting rtos_test::MainThread\n");
   int ch, i, display=1;
   (void)Arg;
#ifdef __MMU_ENUM_H__
   UartPrintfCritical("Starting rtos_test::OS_MMUInit\n");
   OS_MMUInit();
#endif

#ifdef INCLUDE_ETH
   UartPrintfCritical("Starting rtos_test::EthernetInit\n");
   EthernetInit(macAddress);
   UartPrintfCritical("Starting rtos_test::IPInit\n");
   IPInit(EthernetTransmit, macAddress, "plasma");
   UartPrintfCritical("Starting rtos_test::HtmlInit\n");
   HtmlInit(1);
#endif
   ...
   UartPrintfCritical("Starting rtos_test::ConsoleInit\n");
   ConsoleInit();
#endif
