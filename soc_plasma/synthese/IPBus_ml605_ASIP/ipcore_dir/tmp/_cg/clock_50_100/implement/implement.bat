...
xst -ifn xst.scr
move clock_50_100_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clock_50_100_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clock_50_100_exdes.ucf clock_50_100_exdes

echo 'Running map'
map -timing -pr b clock_50_100_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clock_50_100_exdes -w routed.ncd routed.vhd
cd ..
